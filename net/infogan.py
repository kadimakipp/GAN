...
class Generator(nn.Module):
    def __init__(self, latent_dim, n_classes, code_dim, img_size, channels):
        ...
        input_dim = self.latent_dim+self.n_classes+self.code_dim
...
class Discriminator(nn.Module):
    def __init__(self, n_classes, code_dim, channels, img_size):
        ...
        self.latent_layer = nn.Sequential(nn.Linear(128*ds_size**2, self.code_dim))
